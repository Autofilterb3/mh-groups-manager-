...
home_keyboard_pm = InlineKeyboardMarkup(
    [
        ...
        [
            InlineKeyboardButton(
                text="🌐 My Website",
                url=f"https://t.me/+gyZFP-mFh7YyN2Q1",
            ),
            InlineKeyboardButton(
                text="🔰News Channel",
                url=f"https://t.me/+gyZFP-mFh7YyN2Q1",
...
[👋]({random.choice(IMG)}) Hey there {message.from_user.mention}, 
   ...
   My name is Rolex, an  advanced telegram Group management Bot For helpYou Protect Your Groups & Suit For All Your Needs. 
I currently manage about `{len(served_chats)}` groups.I have over `{len(served_users)}` users

⚒ Send Me /help For Get Commands. 
👨‍💻Dᴇᴠᴇʟᴏᴘᴇʀ : @thilak2003
""",
...
👋 Hey there {CallbackQuery.from_user.mention}, 
   ...
   My name is Rolex ,an  advanced telegram Group management Bot For help 
